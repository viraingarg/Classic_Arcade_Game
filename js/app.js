...
{
	this.playerPoints+=10;//increments the points by 10
	var x=document.getElementById('points');
	
	if(this.playerPoints>=100)
	{
    document.write("<h1>Game is finished!!!</h1>");
  }//if points are 100 then game is finished
	else
	{
...
{
	this.playerX=101;//resets the position of the player
	this.playerY=390;
...
var Key=function()
{
	this.KeyX=111;//initial position of the key
	this.KeyY=239;
...
Enemy.prototype.update = function(dt) {
	...
	if(this.enemyX>505)//if the enemy crosses the width of the canvas
	{this.enemyX=-100;}
};
...
var player=new Player(20,390);//positions of the player
